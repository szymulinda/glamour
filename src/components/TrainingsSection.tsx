...
import { BUSINESS_NAME } from "@/lib/site-data";
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 text-center max-w-4xl">
        ...
        <ul className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-14">
          {features.map((f) => (
            <li key={f.title} className="flex flex-col items-center gap-4">
        ...
        <a
          ...
          aria-label={`Poznaj ofertę szkoleń kosmetologicznych ${BUSINESS_NAME}`}
